...
namespace TM.Web.NovelAgentWeb.Migrations
{
    ...
    [Migration("20260614143000_AddContentDocumentBusinessPointers")]
    public partial class AddContentDocumentBusinessPointers : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("""
                CREATE TABLE chapters_new (
                    ...
                    CONSTRAINT FK_chapters_content_documents_current_document_id FOREIGN KEY (current_document_id) REFERENCES content_documents (id) ON DELETE SET NULL,
                ...
                CREATE INDEX idx_chapters_current_document ON chapters (current_document_id);
            ...
            migrationBuilder.Sql("""
                CREATE TABLE materials_new (
                    ...
                    tags TEXT NULL,
                    raw_document_id TEXT NULL,
                    created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
                    vector_chunk_count INTEGER NOT NULL DEFAULT 0,
                    CONSTRAINT FK_materials_content_documents_raw_document_id FOREIGN KEY (raw_document_id) REFERENCES content_documents (id) ON DELETE SET NULL,
                ...
                CREATE INDEX idx_materials_raw_document ON materials (raw_document_id);
            ...
            migrationBuilder.Sql("""
                CREATE TABLE knowledge_processing_tasks_new (
                    ...
                    upload_document_id TEXT NULL,
                    started_at TEXT NULL,
                    completed_at TEXT NULL,
                    created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
                    CONSTRAINT FK_knowledge_processing_tasks_content_documents_upload_document_id FOREIGN KEY (upload_document_id) REFERENCES content_documents (id) ON DELETE SET NULL,
                ...
                CREATE INDEX IX_knowledge_processing_tasks_upload_document_id ON knowledge_processing_tasks (upload_document_id);
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("""
                ...
                DROP TABLE materials;
                ALTER TABLE materials_old RENAME TO materials;
            ...
            migrationBuilder.Sql("""
                CREATE TABLE knowledge_processing_tasks_old (
                    id TEXT NOT NULL CONSTRAINT PK_knowledge_processing_tasks PRIMARY KEY,
                    user_id TEXT NOT NULL,
                    project_id TEXT NULL,
                    file_name TEXT NOT NULL,
                ...
                INSERT INTO knowledge_processing_tasks_old (
                    id,
                    user_id,
                    project_id,
                    file_name,
                ...
                DROP TABLE knowledge_processing_tasks;
                ALTER TABLE knowledge_processing_tasks_old RENAME TO knowledge_processing_tasks;

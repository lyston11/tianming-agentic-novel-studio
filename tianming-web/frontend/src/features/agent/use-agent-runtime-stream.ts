...
import { runtimeEventToSseEvent } from '@/lib/runtime-events';
...
/**
 * Legacy goal/agent runtime stream with REST replay on open, cursor
 * continuation and bounded exponential backoff reconnects.
 */
